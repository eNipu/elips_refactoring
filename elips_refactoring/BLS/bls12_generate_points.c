...
void BLS12_generate_G1_point(EFp12 *P){
    ...
    mpz_tdiv_q(scalar,bls12_parameters.EFp_total,bls12_parameters.order);
...
void BLS12_generate_G2_point(EFp12 *Q){
    ...
    mpz_pow_ui(exp,bls12_parameters.order,2);
    mpz_tdiv_q(exp,bls12_parameters.EFpd_total,exp);
